...
**Read first**: [Environments](/about/concepts/environments) — what an environment owns and how Gym composes it with agent and model servers.

</Info>

## How NeMo Gym Implements Environments

NeMo Gym composes environments and agent-side components as FastAPI servers that communicate over async HTTP:
